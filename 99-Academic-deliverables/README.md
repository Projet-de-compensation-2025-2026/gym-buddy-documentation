...
Assembled for ticket **#71**: [Gym-Buddies-report.pdf](Gym-Buddies-report.pdf) and [Gym-Buddies-defense.pptx](Gym-Buddies-defense.pptx). Live screenshot files 1–16 are **not** in git (Pages is still v0.1.1; capture after a Release of current `develop`). See [screenshots/README.md](screenshots/README.md).
