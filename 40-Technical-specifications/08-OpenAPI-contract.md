...
7. **Target:** OpenAPI must be **tagged**. **Today** git tag **v0.1.0** exists (`info.version` `0.1.0`; ticket **#46** Done). Consumers pin a **tag/version**, not a raw develop SHA GET.
