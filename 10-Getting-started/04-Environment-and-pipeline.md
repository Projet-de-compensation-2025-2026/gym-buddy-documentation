...
| Work | Where |
| --- | --- |
| Point the Pages app at the VPS API and allow that origin (`apiBaseUrl` / CORS). Ticket **#31** is **Not Ready**. Do **not** claim login-from-Pages | `gym-buddy-ui` + `gym-buddy-service` |
