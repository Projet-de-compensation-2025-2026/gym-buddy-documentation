...
| Work | Where |
| --- | --- |
| Login-from-Pages is **not** proven. Blocker 1: UFW 443 is Joaquim’s IPv6 prefix only (do not publish that prefix). Blocker 2: refresh cookie is `SameSite=Lax` and will **not** ride a github.io → VPS credentialed XHR. **Not Ready** ticket only — do **not** Todo it; do **not** start Kernel | `gym-buddy-ui` + UFW / cookies |
