...
- Frontend generates a TypeScript client from a tagged spec, not from whatever a local server emitted today (**landed:** orval 8.22.0 / ticket **#42** Done / `b8da6bf`)
- Backend generates models + API interfaces from that spec at build (**landed:** `generate-sources` / ticket **#41** Done / `c40f122`)
