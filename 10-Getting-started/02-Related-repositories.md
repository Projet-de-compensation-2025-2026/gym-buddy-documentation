...
| `gym-buddy-ui` | https://github.com/Projet-de-compensation-2025-2026/gym-buddy-ui | Private | Angular member app **and** Angular back-office. **Today on `develop`:** TypeScript `~6.0.2` + **`pnpm@11.22.0`** (ui #4 / `63bebed`; committed lockfile; `minimumReleaseAge` **40320**). **Approved:** TypeScript 7.0.0 + pnpm (ticket **#24** is the TS 7 follow-up) | GitHub Pages (static `ng build`) |
...
gym-buddy-ui/                ← Angular 22. Today: TypeScript ~6.0.2 + pnpm@11.22.0. Approved: TypeScript 7.0.0 + pnpm
```
