...
| [07-Technology-choices.md](07-Technology-choices.md) | Java 25 LTS, Angular 22, TypeScript 7.0.0 + pnpm (approved; UI `develop` is TS ~6.0.2 + **pnpm@11.22.0**; ticket #24 is TS 7), PostgreSQL 18, OpenAPI repo |
