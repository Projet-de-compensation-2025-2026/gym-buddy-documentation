...
- **Static sites:** GitHub Pages (this wiki; Angular member app at https://projet-de-compensation-2025-2026.github.io/gym-buddy-ui/ — HTTP **200**, ticket **#30** Done; later OpenAPI UI). Login-from-Pages is ticket **#37**, **Not Ready**, **not** proven. Do **not** Todo **#37**.
