...
- Use the TypeScript version supported by the pinned Angular compiler and declared in the UI manifest/lockfile. Keep strict checking enabled.
...
Use the pinned package manager and committed lockfile. The configured release-age policy and lifecycle-script allowlist live in the UI workspace configuration.
