...
**Today and approved** the UI on `develop` uses **`pnpm@11.22.0`** (ui #4 / `63bebed`; ticket **#23** Done; committed `pnpm-lock.yaml`; `minimumReleaseAge` **40320**) and TypeScript **6** (`~6.0.2`). Joaquim cancelled the TypeScript 6→7 migration (ticket #24 cancelled/closed). Do **not** claim TypeScript 7 shipped. The pnpm contract below is what `develop` uses.
