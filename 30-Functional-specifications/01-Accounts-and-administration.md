...
| FS-ACCT-08 | An admin can lock / unlock an account. Locked users cannot authenticate. Unlock also restores `closed`. |
...
| Route | Mockup | Notes |
| --- | --- | --- |
| `/register`, `/login` | [01-register.jpg](../20-Architecture/mockups/01-register.jpg), [02-login.jpg](../20-Architecture/mockups/02-login.jpg) | Registration and sign-in. |
| `/settings/privacy` | [16-settings-privacy.jpg](../20-Architecture/mockups/16-settings-privacy.jpg) | Change Password and Close Account. Profile Visibility belongs to [02-User-profiles.md](02-User-profiles.md). Notifications are outside this feature scope. |
