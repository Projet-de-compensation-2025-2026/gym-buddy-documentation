...
- Consumers pin an exact published compatible OpenAPI revision and regenerate their clients. The source is the referenced `openapi/openapi.yaml` tree, not generated runtime API documentation.
